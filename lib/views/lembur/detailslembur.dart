...
import 'package:attedancekaryawanump/views/lembur/editlembur.dart';
...
class DetailsLembur extends StatefulWidget {
  int? id;
  String? tanggal;
  int? selama;
  String? widJamMulai;
  ...
  @override
  _DetailsLemburState createState() => _DetailsLemburState();
}

class _DetailsLemburState extends State<DetailsLembur> {
  @override
  void initState() {
    super.initState();
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              ...
              //                           fit: BoxFit.cover,
              //                           image: NetworkImage(
              //                               "http://192.168.14.88:8001/assets/images/${widget.gambar}"))),
              //                 ),
              //               ],
              //             ),
              //           ),
  ...
  deleteData() async {
    var url = Uri.parse(
        'https://attendance.ump.ac.id/api/v1/lembur/delete/${widget.id}');
