...
import 'package:attedancekaryawanump/views/lembur/detailslembur.dart';
...
class _LemburState extends State<Lembur> {
  ...
  getDataRekap() async {
    loading = false;
    final providerrekap =
        Provider.of<ProviderRekapLembur>(context, listen: false);
    await providerrekap.getRekapLembur(
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      floatingActionButton:
        ...
        child: FloatingActionButton(
          ...
          onPressed: () {
            ...
            // Navigator.push(
            //   context,
            //   MaterialPageRoute(builder: (context) => AddLembur()),
            // );
          },
          child: Icon(
            Icons.add,
      ...
      body: Consumer<ProviderRekapLembur>(
                                          ...
                                          onTap: () {
                                            Navigator.of(context)
                                              ...
                                              builder: (context) =>
                                                ...
                                                tanggal: e.tanggal,
                                                selama: e.selama,
                                                widJamMulai: e.jamAwal,
                                                widJamSelesai: e.jamAkhir,
  ...
  Widget cardView(String? tanggalawall, String? tanggalAkhirr, String? nama,
      String? tanggal, String? keterangan, String? selama) {
