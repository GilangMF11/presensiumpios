...
import 'package:attedancekaryawanump/views/log/editlog.dart';
...
class DetailsLog extends StatefulWidget {
  ...
  @override
  _DetailsLogState createState() => _DetailsLogState();
}
...
class _DetailsLogState extends State<DetailsLog> {
  ...
  deleteData() async {
    var url = Uri.parse(
        'https://attendance.ump.ac.id/api/v1/logbook/delete/${widget.id}');
