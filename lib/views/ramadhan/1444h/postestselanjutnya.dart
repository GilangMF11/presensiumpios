...
class PostestSelanjutnya extends StatefulWidget {
  int? index;
  PostestSelanjutnya({required this.index});

  @override
  State<PostestSelanjutnya> createState() => _PostestSelanjutnyaState();
}

class _PostestSelanjutnyaState extends State<PostestSelanjutnya> {
  int? jawaban;
  bool? loading = true;
