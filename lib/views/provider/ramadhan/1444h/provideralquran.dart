...
class ProviderAlQuran with ChangeNotifier {
  ...
  getImsyakiyah(String? date) async {
    ...
    var url =
        Uri.parse('https://developer.ump.ac.id/PD/ramadhan1444/imsakiyah.php');
  ...
  getMenuBaik() async {
    ...
    var url = Uri.parse(
        'https://developer.ump.ac.id/PD/ramadhan1444/infokegiatanterdaftar.php');
  ...
  cekEvaluasi() async {
    ...
    var url =
        Uri.parse('https://developer.ump.ac.id/PD/ramadhan1444/evaluasi.php');
    var body = {
      "USERNAME": username,
  ...
  getSoalPretest() async {
    ...
    var url = Uri.parse(
        'https://developer.ump.ac.id/PD/ramadhan1444/pretest_api.php');
    var body = {
      "USERNAME": username,
      "gelombang_id": gelombang,
      "perintah_id": "1",
  ...
  getSoalPos() async {
    ...
    var url = Uri.parse(
        'https://developer.ump.ac.id/PD/ramadhan1444/posttest_api.php');
    var body = {
      "USERNAME": username,
      "gelombang_id": gelombang,
      "perintah_id": "1",
  ...
  getPengajian() async {
    ...
    var url = Uri.parse(
        'https://developer.ump.ac.id/PD/ramadhan1444/presensi_sesi.php');
    var body = {
      "USERNAME": username,
      "gelombang_id": gelombang,
      "perintah_id": "1",
  ...
  getDoa() async {
    ...
    var url =
        Uri.parse('https://developer.ump.ac.id/PD/ramadhan1444/doaharian.php');
    var urltoken = Uri.parse('https://developer.ump.ac.id/token/index.php');
    Map getToken = {
      "username": "pangkalandata",
      "password": "ump",
  ...
  getEvaluasiQusioner() async {
    ...
    var url = Uri.parse(
        'https://developer.ump.ac.id/PD/ramadhan1444/evaluasi_kuesioner_api.php');
    var body = {
      "USERNAME": username,
      "gelombang_id": gelombang,
      "perintah_id": "1",
  ...
  getRekapPresensiRamadhan() async {
    ...
    var url = Uri.parse(
        'https://developer.ump.ac.id/PD/ramadhan1444/presensi_sesi_detail.php');
    var body = {
      "USERNAME": username,
      "gelombang_id": gelombang,
      "perintah_id": "1",
  ...
  getSertifikat() async {
    ...
    var url =
        Uri.parse('https://developer.ump.ac.id/PD/ramadhan1444/sertifikat.php');
    var body = {
      "USERNAME": username,
      "gelombang_id": gelombang,
      "perintah_id": "1",
